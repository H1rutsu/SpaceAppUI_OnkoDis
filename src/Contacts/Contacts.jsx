        ...
        <div className={styles.contacts}>
            <div className={styles.contacts_info}>
                <div className={styles.info}>
                    ...
                    <h2>ул. Клиническая, 97, к.1, Саратов, Саратовская обл., 410053</h2>
                    <h2>pochta@mail.com</h2>
                    <h2>8 (845) 239-44-21</h2>
                    <div className={styles.icons}>
                        <div className={styles.icons_left}>
                            <img src="images/logo_telegram.png" className={styles.logo_tg}></img>
                            <img src="images/logo_vk.png" className={styles.logo_vk}></img>
                            <img src="images/logo_youtube.png" className={styles.logo_yt}></img>
                        </div>
                        <div className={styles.icons_right}>
                            <img src="images/arrow_left.png" className={styles.arrow_left}></img>
                            <img src="images/arrow_right.png" className={styles.arrow_right}></img>
                        </div>
