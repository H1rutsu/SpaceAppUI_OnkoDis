    ...
    <>
      ...
      <div className={styles.header}>
        ...
        <ul className={styles.header_header_ul}>
          <li>
            <NavLink to="/about" className={styles.header_link}>
              О Нас
            </NavLink>
          </li>
          <li>
            <NavLink to="/doctors" className={styles.header_link}>
              Врачи
            </NavLink>
          </li>
          <li>
            <NavLink to="/patients" className={styles.header_link}>
              Пациентам
            </NavLink>
          </li>
          <li>
          ...
          <li>
            <NavLink to="/reviews" className={styles.header_link}>
              Отзывы
            </NavLink>
          </li>
        </ul>
